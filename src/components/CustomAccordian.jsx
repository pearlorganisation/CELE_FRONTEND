export default function AccordionElevatedIcon() {
  return (
    <>
      <section className="w-full bg-white divide-y rounded shadow-md divide-slate-200 shadow-slate-200">
        ...
        <details className="p-4 group">
          ...
          <p className="mt-4 text-slate-500">
            Our team has used the currently latest TailwindCSS version. The code
            is used in its original form without any customization or third
            party dependencies.
          </p>
        </details>
      </section>
