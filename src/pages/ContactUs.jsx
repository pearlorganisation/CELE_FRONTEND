    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative h-80">
        <div 
          ...
          style={{ backgroundImage: "url('https://lirp.cdn-website.com/5d83079e/dms3rep/multi/opt/About+Mothe+Funeral+Home+LLC+located+in+Southern+Louisiana+with+Funeral+Homes+in+New+Orleans-+Harvey+and+Merrero+LA-1920w.jpg')" }}
        >
      ...
      <div className="bg-green-800 text-white py-3">
        <div className="container mx-auto flex justify-center space-x-8 text-sm">
          <a href="#" className="hover:underline">ABOUT US</a>
          <a href="#" className="hover:underline">OUR HISTORY & STAFF</a>
          <a href="#" className="hover:underline">CONTACT US</a>
          <a href="#" className="hover:underline">REVIEWS</a>
          <a href="#" className="hover:underline">AWARDS</a>
          <a href="#" className="hover:underline">OUR CALENDAR</a>
        </div>
      </div>
      ...
      <main className="flex-grow bg-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <h2 className="text-2xl text-green-800 font-medium mb-4">Need Immediate Services? We Are Available 24/7</h2>
            <div className="flex flex-wrap justify-center gap-4">
              <button className="border border-green-800 rounded-full px-4 py-2 text-sm hover:bg-green-800 hover:text-white transition-colors">
          ...
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl text-green-800 font-bold text-center mb-6">Contact Us Form</h2>
            <p className="text-center mb-8 text-gray-700">
              Please contact us about any of our services or to meet with one of our funeral service professionals. You may contact our general office at <a href="tel:5043664343" className="text-green-800 font-medium">(504) 366-4343</a>, or fax us at <a href="tel:5043664888" className="text-green-800 font-medium">(504) 366-4888</a>. For a detailed list of our locations <a href="#" className="text-green-800 font-medium">click here</a> or send us an email using our contact form below.
            </p>
            ...
            <form className="space-y-4">
              <div>
                <input 
                  type="text" 
                  placeholder="Name" 
                  className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-green-800 focus:border-transparent"
                />
              </div>
              <div>
                <input 
              ...
              <div className="text-center">
                <button type="submit" className="bg-green-800 text-white px-8 py-3 rounded hover:bg-green-900 transition-colors">
                  Submit
                </button>
              </div>
            </form>
...
function NavItem({ text }) {
  return (
    <div className="relative group">
      <button className="flex items-center text-gray-800 hover:text-green-800">
        {text}
        <ChevronDown className="h-4 w-4 ml-1" />
      </button>
      <div className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md py-2 z-10 hidden group-hover:block">
        <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-green-800">Option 1</a>
        <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-green-800">Option 2</a>
        <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-green-800">Option 3</a>
      </div>
    </div>
  );
}
...
// import { submitContact } from "../features/actions/contactActions";
